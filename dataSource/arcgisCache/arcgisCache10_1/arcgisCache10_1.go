...
// 通过xml获取瓦片配置信息
func (a *ArcgisCache10_1) getCacheInfo() (conf.CacheInfo, error) {
...
// 通过cdi获取Envelope配置信息
func (a *ArcgisCache10_1) getEnvelope() (conf.EnvelopeN, error) {
	content, err := ioutil.ReadFile(fmt.Sprintf(`%s/conf.cdi`, a.Path))
	if err != nil {
